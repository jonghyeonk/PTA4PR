...
def apply_playout(net, initial_marking, no_traces=10000, max_trace_length=100000,
...
def apply(net: PetriNet, initial_marking: Marking, final_marking: Marking = None,
    ...
    no_traces = exec_utils.get_param_value(Parameters.NO_TRACES, parameters, 100000)
